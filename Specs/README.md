...
- [SPEC-0003 System Requirements](SPEC-0003-system-requirements.md) — `Accepted v1.1`
- [SPEC-0004 Feature Catalog](SPEC-0004-feature-catalog.md) — `Accepted v1.1`
- [SPEC-0005 Capture Workflow](SPEC-0005-capture-workflow.md) — `Accepted v1.0`
- [SPEC-0006 Workflow Boundaries and Feedback](SPEC-0006-workflow-boundaries-and-feedback.md) — `Accepted v1.0`
- [SPEC-0007 Clipboard Handoff](SPEC-0007-clipboard-handoff.md) — `Accepted v1.0`
...
- Save creates PNG and writes Clipboard.
