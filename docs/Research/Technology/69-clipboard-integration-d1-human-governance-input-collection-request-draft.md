...
flowchart LR
  ...
  B --> C["RESEARCH-TECH-CLIPBOARD-041 Collection Request Draft"]
  C -. future Submission-readiness Reassessment .-> D["Future Submission-readiness Reassessment"]
  C -. future Explicit Request Submission Instruction .-> E["Future Explicit Request Submission Instruction"]
  C -. future Request Submission .-> F["Future Request Submission"]
  C -. future Collection Authorization .-> G["Future Collection Authorization"]
  C -. future Collection-start Permission .-> H["Future Collection-start Permission"]
  C -. future Worksheet Distribution .-> I["Future Worksheet Distribution"]
  C -. future Human Input .-> J["Future Human Input"]
  C -. future Role-holder and Channel Selection Records .-> K["Future Role-holder and Channel Selection Records"]
  C -. future D1 Request Submissions .-> L["Future D1 Request Submissions"]
  C -. future Human Decisions .-> M["Future Human Decisions"]
  C -. future Execution Permissions .-> N["Future Execution Permissions"]
  C -. future Inspections .-> O["Future Inspections"]
  C -. future Observations .-> P["Future Observations"]
  C -. future Separate Persistent Evidence Requests .-> Q["Future Separate Persistent Evidence Requests"]
```
